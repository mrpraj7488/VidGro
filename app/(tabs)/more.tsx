...
export default function MoreTab() {
  ...
  // Debug menu state changes with more detail
  useEffect(() => {
    console.log('🔍 More tab - menuVisible changed to:', menuVisible, 'at', new Date().toISOString());
    console.log('🔍 More tab - Component will re-render with menuVisible:', menuVisible);
  }, [menuVisible]);
