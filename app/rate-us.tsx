...
export default function RateUsScreen() {
        ...
        <Animated.View key={star} style={animatedStarStyle}>
          ...
          >
            <Star
              ...
              color={star <= rating ? '#800080' : theme.border}
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      >
        {/* Rating Section */}
        <Animated.View style={[styles.ratingSection, { backgroundColor: theme.card }]}>
          <View style={styles.iconContainer}>
            <Award size={36} color="#800080" />
          </View>
          <Text style={[styles.ratingTitle, { color: theme.text }, isVerySmallScreen && styles.ratingTitleSmall]}>
            How's your experience?
          </Text>
          <Text style={[styles.ratingSubtitle, { color: theme.textSecondary }, isVerySmallScreen && styles.ratingSubtitleSmall]}>
        ...
        {/* Feedback Section */}
        <Animated.View style={[styles.feedbackSection, { backgroundColor: theme.card }]}>
          <View style={styles.sectionHeader}>
            <MessageSquare size={20} color="#800080" />
            <Text style={[styles.feedbackTitle, { color: theme.text }, isVerySmallScreen && styles.feedbackTitleSmall]}>
        ...
        {/* Benefits Section */}
        <Animated.View style={[styles.benefitsSection, { backgroundColor: theme.card }]}>
          <View style={styles.sectionHeader}>
            <Sparkles size={20} color="#800080" />
            <Text style={[styles.benefitsTitle, { color: theme.text }, isVerySmallScreen && styles.benefitsTitleSmall]}>
              Why Rate Us?
            </Text>
          </View>
          <View style={styles.benefitItem}>
            ...
            <Text style={[styles.benefitText, { color: theme.textSecondary }, isVerySmallScreen && styles.benefitTextSmall]}>
        ...
        {/* Store Links */}
        <Animated.View style={[styles.storeLinksSection, { backgroundColor: theme.card }]}>
          <Text style={[styles.storeLinksTitle, { color: theme.text }, isVerySmallScreen && styles.storeLinksTitleSmall]}>
          ...
          <TouchableOpacity 
            ...
            activeOpacity={0.7}
          >
            <Text style={[styles.storeButtonText, { color: theme.text }]}>📱 App Store</Text>
          </TouchableOpacity>
          <TouchableOpacity 
            style={[styles.storeButton, { 
              backgroundColor: theme.card, 
            ...
            activeOpacity={0.7}
          >
            <Text style={[styles.storeButtonText, { color: theme.text }]}>🤖 Google Play</Text>
          </TouchableOpacity>
        </Animated.View>

        {/* Thank You Message */}
        <Animated.View style={[styles.thankYouSection, { backgroundColor: theme.card, borderLeftColor: '#800080' }]}>
          <Text style={[styles.thankYouText, { color: theme.text }, isVerySmallScreen && styles.thankYouTextSmall]}>
