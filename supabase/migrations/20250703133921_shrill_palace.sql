/*
  # Complete VidGro Database Setup
  
  This script sets up the entire database from scratch including:
...
/*
-- Sample videos (these will be created after users sign up)
INSERT INTO videos (user_id, youtube_url, title, description, duration_seconds, coin_cost, coin_reward, target_views) VALUES
  ('00000000-0000-0000-0000-000000000001', 'https://youtube.com/watch?v=dQw4w9WgXcQ', 'Amazing Tutorial', 'Learn something new today!', 120, 100, 10, 50),
  ('00000000-0000-0000-0000-000000000002', 'https://youtube.com/watch?v=jNQXAC9IVRw', 'Funny Video', 'Laugh out loud moments', 90, 75, 8, 30);
*/
...
BEGIN
  ...
  RAISE NOTICE 'Created functions: handle_new_user, update_user_coins, can_user_watch_video, get_next_video_for_user, complete_video_view';
